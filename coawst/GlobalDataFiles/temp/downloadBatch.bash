...
now=`cat dates.txt | head -1`
echo "now $now"

urlFile=url.txt


names=("Uwind"     "Vwind"     "lwrad_down" "lhflux" 	  "Tair"      "swrad"    "Qair"      "swrad_up" "sensible"      "latent"      "Pair")
times=("wind_time" "wind_time" "lrf_time"   "lhflux_time" "tair_time" "srf_time" "qair_time" "srf_time" "sensible_time" "latent_time" "pair_time")
...
do
    ...
    do
        ...
        datePlus=`date -d "$NOW + $hour hour" "+%Y-%m-%dT%H:%M:%S"`

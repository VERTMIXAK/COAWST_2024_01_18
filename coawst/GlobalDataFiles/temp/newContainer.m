...
names3 = {'Pair',      'lwrad_down', 'lhflux'     , 'swrad',    'swrad_up', 'sensible',      'latent'};
times3 = {'pair_time', 'lrf_time',   'lhflux_time', 'srf_time', 'srf_time', 'sensible_time', 'latent_time'};
...
units3 = {'Pa','W m-2','W m-2','W m-2','W m-2','W m-2','W m-2'};

...
names=("Uwind"     "Vwind"     "lwrad_down" "lhflux"	  "Tair"      "swrad"    "Qair"      "sensible"      "latent"      "swrad_up"  "Pair")
times=("wind_time" "wind_time" "lrf_time"   "lhflux_time" "tair_time" "srf_time" "qair_time" "sensible_time" "latent_time" "srf_time"  "pair_time")
...
mv GFS_swrad_up*.nc   $archiveDir/swrad_up
mv GFS_swrad*.nc   $archiveDir/swrad
